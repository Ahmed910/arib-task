...
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update', $employee->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="salary" type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary', $employee->salary) }}" required autocomplete="salary">
    ...
    <div class="col-md-6">
        ...
        @if ($employee->image)
            <div class="mt-2">
                <img src="{{ asset('storage/images/employees/' . $employee->image) }}" alt="Employee Image" class="img-thumbnail" style="max-width: 200px;">
            </div>
        @endif
